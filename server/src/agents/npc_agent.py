...
from .nodes.episodic_memory import make_episodic_memory_node
...
def create_npc_agent(
    ...
    episodic_memory_node = make_episodic_memory_node(llm)  # type: ignore[arg-type]
    ...
    graph.add_node("episodic_memory", episodic_memory_node)
    ...
    graph.add_edge("reflect", "episodic_memory")
    graph.add_conditional_edges(
        "episodic_memory",
        _should_summarize,
