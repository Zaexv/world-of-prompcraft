...
_TOOL_RULES_PREAMBLE = (
    ...
    "- When the player wants to SELL you an item: call buy_item_from_player(item_name). "
    "It pays the item's fair value from your coffers and takes the item. Only merchants "
    "buy goods — other NPCs should decline.\n"
    "- When spawning effects: call spawn_effect with a specific type.\n"
    "- When offering a quest: call offer_quest(quest_id) for a known quest, or "
    "offer_custom_quest(...) to invent one on the spot. When the player has "
    "finished every objective, call complete_quest(quest_id) to pay the reward. "
    "Kill/collect/dungeon objectives advance on their own; only call "
    "advance_quest_objective for 'report back' steps you alone can confirm.\n"
...
NPC_PERSONALITIES: dict[str, dict[str, Any]] = {
    ...
    "merchant_01": {
        ...
        "system_prompt": (
            ...
            "- If the player wants to SELL you something, call buy_item_from_player(item) and "
            "pay them, '¡Trato hecho, cariño!'.\n"
    ...
    "churrero_01": {
        ...
        "system_prompt": (
            ...
            "- If the player wants to sell you goods, call buy_item_from_player(item).\n\n"
            "INVENTORY:\n"
    ...
    "sage_01": {
        ...
        "system_prompt": (
            ...
            "- For predefined quests (The Crystal Tear), use offer_quest('crystal_tear').\n"
            "- For improvised quests, use offer_custom_quest(...) instead.\n"
            "- When the player has fulfilled every objective, use complete_quest('crystal_tear').\n"
            ...
            "Lake. (USE offer_quest('crystal_tear') -- predefined quest)\n"
            "2. 'Whispers in the Wind' -- Listen to three ancient stones and report "
            "what they say. (USE offer_custom_quest(...) -- improvised quest)\n"
            "3. 'The Dragon's Riddle' -- Bring Ignathar's answer to the Sage's "
            "riddle. (USE offer_custom_quest(...) -- improvised quest)\n\n"
            "BEHAVIOR RULES:\n"
    ...
    "eltito_01": {
        ...
        "system_prompt": (
            ...
            "offer_quest('sacred_flame'). Say something like: 'Maaan, I've got this "
