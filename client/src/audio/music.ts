...
export const ZONE_MUSIC: Record<string, ZoneMusicDef> = {
  "Blasted Suarezlands": { rootNote: "D2", scale: ["D","E","F","G","A","Bb"], bpm: 55, padType: 'dark', arpSpeed: 'slow', bassOctave: 1 },
  ...
  "Ember Wastes":        { rootNote: "E2", scale: ["E","F#","G","A","B","C"], bpm: 60, padType: 'dark', arpSpeed: 'medium', bassOctave: 1 },
  "Crystal Tundra":      { rootNote: "C2", scale: ["C","D","Eb","G","Ab"], bpm: 45, padType: 'airy', arpSpeed: 'slow', bassOctave: 2 },
  "Twilight Marsh":      { rootNote: "F2", scale: ["F","G","Ab","C","D"], bpm: 50, padType: 'dark', arpSpeed: 'slow', bassOctave: 1 },
  "Sunlit Meadows":      { rootNote: "C2", scale: ["C","D","E","G","A","B"], bpm: 65, padType: 'warm', arpSpeed: 'medium', bassOctave: 2 },
