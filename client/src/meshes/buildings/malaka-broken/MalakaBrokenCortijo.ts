...
export class MalakaBrokenCortijo extends Mesh {
  ...
  build(ctx: BuildContext): THREE.LOD {
    ...
    towerZoc.userData.noCollision = true;
    g.add(towerZoc);
    ...
    bZoc.userData.noCollision = true;
    g.add(bZoc);
    ...
    backWing.userData.noCollision = true;
    g.add(backWing);
    ...
    bRoof.userData.noCollision = true;
    g.add(bRoof);
    ...
    fZoc.userData.noCollision = true;
    g.add(fZoc);
    ...
    frontWing.userData.noCollision = true;
    g.add(frontWing);
    ...
    terrace.userData.noCollision = true;
    g.add(terrace);
